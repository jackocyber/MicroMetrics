...
model_d_1 <- lm(passrate2 ~ win + vote + vote*lose + vote*win, data = restrict)

model_d_2 <- lm(passrate2 ~ win + vote + vote*lose + vote*win, data = restrict)

model_d_3 <- lm(passrate2 ~ win + vote + (vote^2)*lose + (vote^2)*win, data = restrict)

model_d_4 <- lm(passrate2 ~ win + vote + vote*lose + vote*win + (vote^2)*lose + (vote^2)*win, data = restrict)
