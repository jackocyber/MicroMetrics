...
When I experimented with a threshold of smaller [25,75] I get slightly different results compared to my results previously from (d) and they also differ from Clark's results. The reason for these difference is the same reason why Clark chose no
(f)
(g)
(h)
(i)
