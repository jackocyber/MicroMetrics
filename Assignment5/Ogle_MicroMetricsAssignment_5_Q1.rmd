...
* I attempted to estimate the some regressions where vote was squared, but I got the same results. I would expect to see different results specifically, I would have expected to find that 
