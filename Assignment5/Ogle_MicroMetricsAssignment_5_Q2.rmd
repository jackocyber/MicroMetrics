...
clean air.
b) What is the running variable, X?
...
c) What is the treatment variable, D, and how is it determined by X? Is this
a sharp or a fuzzy RDD?
...
d) Argue why (or why not) an RDD has more credible identifying assumptions
than a multiple linear regression model to answer the causal question(
s) of interest?
